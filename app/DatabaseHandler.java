...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    private static final String dbPath = "/data/data/com.example.nhanbietdongvat/databases/nbdongvat.sqlite";
    private static final String dbName = "nbdongvat.sqlite";
